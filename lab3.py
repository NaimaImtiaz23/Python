...
Original file is located at
    https://colab.research.google.com/drive/1gMp73VfhJ2hrZoGauxc_wp1ONQEqPNt8

# Dictionary

I took 8 nodes containing different cities of Pakistan and these nodes are futher connected to eachother making an undirected graph.

def is used in python to define function. I wrote function bfs_shortpath that will take graph, starting and ending point as an argument. to return shortest path.
"""
